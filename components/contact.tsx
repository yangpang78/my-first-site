...
export function Contact() {
  ...
  const defaultInfo = {
    ...
    title: "상무이사",
    company: "개성건설",
    experience: "10년 이상 경력",
    phone: "010-3713-****",
    email: "didtkd97@naver.com",
    website: "",
    location: "경기도 안양시 만안구 안양로",
    workTime: "평일 09:00 - 18:00",
    responseTime: "24시간 이내 응답",
    sectionTitle: "연락처",
    sectionSubtitle: "사랑과 도움이 필요한 모든분께 고민 상담해드립니다.",
    qrTitle: "QR 코드로 연락처 저장",
    qrSubtitle: "스캔하면 연락처가 자동으로 저장됩니다",
    bottomMessage: "항상 도움이 되는 사람이 되겠습니다.",
    bottomSubMessage: "단부건 35대 원우회와 산악회의 무한한 발전을 기대합니다.",
