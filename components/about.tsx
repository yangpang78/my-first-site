...
export function About() {
  ...
  const defaultInfo = {
    title: "소개",
    subtitle: "자연 그리고 사람이 만든 주거의 명작",
    background: {"image":"","video":"","color":"","opacity":0.1},
    experienceCards: [{"icon":"briefcase","title":"개성건설","period":"20?? - 현재","description":"전략기획실 기획팀"},{"icon":"graduation","title":"단국대학교 부동산건설대학원","period":"2024 - 현재","description":"도시 및 부동산개발학과"},{"icon":"award","title":"주요 경력","period":"개성건설 상무이사","description":"단부건 35대 원우회 행사위원장"}],
    skills: [{"icon":"code","title":"건축사업","description":"최고의 효율성과 편의성이 구비된 첨단건축, 합리적인 선택을통해 최상의 건축물 창조  "},{"icon":"database","title":"토목사업","description":"대한민국의 근간이 되는 기반시설, 도로, 교량 건설로 국가 경쟁력 향상에 이바지"},{"icon":"palette","title":"시설물 유지관리","description":"시설물의 안전 및 효율적인 유지관리를 통한 기존 시설물을오래 사용할 수 있도록 합니다.  "}],
    storyTitle: "양빵 나의 이야기~",
    story: ["개성건설 입사후 상무이사로 재직중","금정역 개성로니엘 분양","평촌 개성하이뷰 상가 분양\n","관양동 주상복합 개성하이빌 분양","단국대 부동산 건설대학원 2024년 35기로 입학(도시 및 부동산 개발)","35대 원우회 행사위원장(2025.09.01~현재)","단부건 산악회 할동으로 2025년 7월 일본 후지산 정상등반(3,766m)","후지산(3,776m), 단부건 산악회 여성부문 최고 기록 갱신"],
    storyImage: "/uploads/about-image-1763113402008.jpg",
    hobbies: ["단부건 35기","맛집 탐방","골프, 등산","✈️ 단부건 산악회 "]
  }
